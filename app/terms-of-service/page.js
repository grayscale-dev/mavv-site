export default function TermsOfService() {
  return (
    <main className="mx-auto py-12 text-left font-normal text-sm">
      <header className="mb-10">
        <h1 className="text-3xl sm:text-6xl font-bold tracking-tight text-neutral-400 dark:text-neutral-700">
          Terms of Service
        </h1>
      ...
      <section className="space-y-4">
        <p>
          These Terms of Service (<span className="font-semibold">"Terms"</span>
          ) are a binding agreement between
        ...
        <div className="mt-4 rounded-lg border-l-4 border-blue-500/60 bg-blue-50 p-4 text-sm leading-relaxed text-blue-900 dark:border-blue-400/60 dark:bg-blue-950/40 dark:text-blue-200">
          <p className="font-semibold">Important:</p>
          <p className="mt-1">
            The Site promotes and provides information about a prospective
            software product called <span className="font-semibold">mavv</span>.
            The Site itself does <span className="font-semibold">not</span>{" "}
            provide banking services, financial services, or the application’s
            functionality. Nothing on the Site is financial, legal, tax, or
            investment advice, and nothing on the Site is an offer to provide
            regulated services.
          </p>
        </div>
      </section>
      ...
      <section id="eligibility" className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6">
          <li>
            ...
            your jurisdiction) to use the Site. If you are under 18, you may use
            the Site only with the consent of a parent or legal guardian.
          </li>
          <li>
      ...
      <section id="marketing" className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6">
          <li>
            ...
            Features described may be conceptual, under development, or subject
      ...
      <section id="communications" className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6">
          <li>
            The Site may offer forms to join a waitlist, request information, or
            contact us. By submitting your information, you consent to our
            contacting you via the channels you provide (e.g., email or, if
            applicable, SMS). You may opt out as described in those
            communications.
          </li>
          <li>
            You represent that the information you provide is accurate and that
      ...
      <section id="ip" className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            non-commercial use. Except as expressly permitted, you may not: (a)
            copy, modify, or create derivative works; (b) distribute, sell,
            lease, or sublicense the Site or its content; (c) reverse engineer
            or attempt to extract source code; or (d) remove proprietary
            notices.
          </li>
          <li>
      ...
      <section id="third-party" className="mt-10">
        ...
        <p className="mt-3">
          ...
          control and are <span className="font-semibold">not responsible</span>{" "}
          for those sites or services. Your use of them is at your own risk and
          may be subject to third-party terms and policies.
        </p>
      </section>
      ...
      <section id="disclaimers" className="mt-10">
        ...
        <p className="mt-3">
          ...
          <span className="font-semibold">“AS AVAILABLE.”</span> TO THE MAXIMUM
          ...
          WARRANT THAT THE SITE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE, OR
      ...
      <section id="limitation" className="mt-10">
        ...
        <p className="mt-3">
          ...
          (INCLUDING OUR AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, OR
          ...
          (OR INABILITY TO USE) THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE
          POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ANY CLAIM ARISING
          OUT OF OR RELATING TO THESE TERMS OR THE SITE WILL NOT EXCEED
          <span className="font-semibold">
      ...
      <section id="changes" className="mt-10">
        ...
        <p className="mt-3">
          ...
          without notice. We may also update these Terms from time to time. The
          “Last Updated” date indicates when these Terms were last revised. Your
      ...
      <section id="governing-law" className="mt-10">
        ...
        <p className="mt-3">
          ...
          <span className="font-semibold">Salt Lake County, Utah</span> for any
          action not subject to arbitration (if applicable) and for any requests
      ...
      <section id="export" className="mt-10">
        ...
        <p className="mt-3">
          You are responsible for compliance with local laws. Accessing the Site
          from territories where its content is illegal is prohibited. You
          represent you are not located in, under the control of, or a national
          or resident of any embargoed country or on any U.S. government
          denied-party list.
        </p>
      </section>
      ...
      <section id="misc" className="mt-10">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6">
          <li>
            ...
            provision is found unenforceable, it will be modified to the minimum
          ...
          <li>
            ...
            Site and supersede all prior or contemporaneous understandings
            regarding the Site.
          </li>
          <li>
